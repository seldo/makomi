...
exports.generate = function () {
  ...
  // FIXME: these things require, you know, parameters of some kind
  require('./generators/router').generate()
  require('./generators/controllers').generate()
  require('./generators/views').generate()
}
