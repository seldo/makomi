...
exports.compile = function(layout,renderFragment,cb) {
  ...
  var renderView = function(file,context,cb) {
    ...
    fs.readFile(templateFile,'utf-8',function(er,data) {
      var renderedView = renderFragment(data,context)
      cb(renderedView)
    })
  }
  ...
  if(layout.templates) {
    ...
    for(var t in layout.templates) {
      ...
      exports.compile(layout.templates[t],renderFragment,function(renderedView) {
